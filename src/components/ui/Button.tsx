  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary"   && "bg-[var(--gold)] text-[var(--bg-primary)] hover:bg-[var(--gold-light)] active:scale-[0.98]",
        variant === "secondary" && "bg-transparent border border-[var(--border-default)] text-[var(--text-primary)] hover:border-[var(--border-strong)] hover:bg-[rgba(226,168,39,0.06)]",
